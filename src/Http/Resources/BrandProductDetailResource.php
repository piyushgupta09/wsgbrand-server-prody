        ...
        return [
            ...
            'ledgers' => collect($this->ledgers)->map(function ($ledger) {
                return [
                    ...
                    'balance_qty' => $ledger->getLedgerBalanceQty(),
                    'readyable_qty' => $ledger->getNetReadyableQty(),
                    'demandable_qty' => $ledger->getNetDemandableQty(),
                    'dispatchable_qty' => $ledger->getNetDispatchableQty(),
